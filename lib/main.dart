...
void main() async {
  ...
  // Initialize timezone database FIRST (required for alarms)
  tz.initializeTimeZones();
  
  // Initialize Hive (using FutureYou's proven pattern)
  ...
  // Initialize workout alarm service (based on FutureYou's AlarmService)
